...
document.addEventListener('DOMContentLoaded', function() {
    document.title = "Yowl - Your Online World Link";
    document.documentElement.innerHTML = document.documentElement.innerHTML.replace(/<!--[\s\S]*?-->/g, '');
    document.body.innerHTML = document.body.innerHTML.replace(/href="chat\.html"/g, 'href="public"');
});
